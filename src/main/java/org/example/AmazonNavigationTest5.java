/**
 * VERSION 5: Architecture Update - Page Object Model (POM) Integration
 * * This iteration upgrades Version 4 by decoupling the UI interactions from the
 * main script. It introduces the Page Object Model design pattern, routing
 * search and verification logic through dedicated page classes to improve
 * maintainability and code cleanliness.
 */
...
public class AmazonNavigationTest5
{
    ...
    public static void main(String[] args)
    {
        ...
        while (true) {
            ...
            try {
                ...
                homePage.enterSearchTerm(driver, "OnePlus Buds 4");

                AmazonSearchResultsPage searchResultsPage = new AmazonSearchResultsPage();
                currentPrice = searchResultsPage.getVerifiedPrice(driver, "OnePlus Buds 4");
