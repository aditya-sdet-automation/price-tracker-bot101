/*
  Experimental Search-Based Tracker (Deprecated)
This script was built to test dynamic search-bar scraping, ad-evasion, and heuristic word-matching.
It successfully bypassed sponsored tags and blacklisted accessories.
However, it was deprecated in favor of AmazonNavigationTest7 (Direct ASIN Navigation) because Amazon's unpredictable UI
and dynamic search aliases ("Compatible with", etc.) make text-based verification mathematically unstable for
enterprise tracking.
*/
package org.example;
...
public class AmazonNavigationTest6
{
        ...
        while (true) {
            ...
            try {
                ...
                while(csvscanner.hasNextLine()) {
                    ...
                    //Array of balcklisted words to prevent scraping price of wrong product
                    String[] itemBlacklist = {"nord","lite","case","strap","cover","protector"};
                    ...
                    homePage.enterSearchTerm(driver, fullProductName);
                    AmazonSearchResultsPage2 searchResultsPage = new AmazonSearchResultsPage2();
                    currentPrice = searchResultsPage.getVerifiedPrice(driver, fullProductName, itemBlacklist);
