...
public class AmazonNavigationTest3
{
    ...
    public static void main(String[] args)
    {
        ...
        while (true) {
            try {
                ...
                WebElement searchElement = wait.until(d -> d.findElement(By.cssSelector("input#twotabsearchtextbox")));
                WebElement searchGlass = wait.until(d -> d.findElement(By.cssSelector("input#nav-search-submit-button")));
